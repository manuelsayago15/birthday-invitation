...
export default function Details() {
  return (
    <section className="relative bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden px-6">
      ...
      <motion.p
        ...
        className="font-[family-name:var(--font-tech)] text-[#c9a84c] text-xs tracking-[0.5em] uppercase mb-4"
      >
      ...
      <motion.h1
        ...
        className="font-[family-name:var(--font-vintage)] text-white text-[clamp(2.5rem,8vw,6rem)] text-center leading-tight mb-6"
      >
        Un Cumpleaños
      </motion.h1>
      ...
      >
        <div className="text-center">
          ...
          <p className="font-[family-name:var(--font-vintage)] text-white text-xl">15 de Mayo, 2025</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="font-[family-name:var(--font-vintage)] text-white text-xl">Por revelar</p>
        </div>
